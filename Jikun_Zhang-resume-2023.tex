...
\begin{center}
    ...
    \small +65 9387 9897 $|$ \href{mailto:x@x.com}{\underline{zhangjikun907475@gmail.com}} $|$ 
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{GPA: 4.75, First Class Honours.}
        \resumeItem{Distinction in Competitive Programming, Database Systems, Computer Organisation, Data Structures and Algorithms.}
    \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Contributed features to Isomer such as preview images, last updated time and placeholder files.}
...
%-------------------------------------------
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Developed a native gateway client with Boost.ASIO that communicates order book instructions in TCP protocol to London Stock Exchange Group’s matching engine service.}
        \resumeItem{Developed a market data collection service with Boost.Beast that collects market data of other exchanges over websockets and stores it in Apache Parquet format.}
        \resumeItem{Set up integration tests in GoogleTest framework for native gateway client and matching engine service.}
        \resumeItem{Contributed to the development of a market maker that quotes at 1 tick spread for digital assets with highest trade volume.}
    \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \footnotesize{\item{
     ...
     \textbf{Modeling \& Analytics}{: Python, NumPy, Pandas, Matplotlib, sklearn, Jupyter Notebooks} \\
     \textbf{Tools \& Misc}{: Git, GitHub, Docker, Amazon Web Services, \LaTeX} \\
    }}
 \end{itemize}
